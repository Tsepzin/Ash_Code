...
for dates in daterange:
	...
	df = df[(df.PortfolioIDCode == 95027)]
	...
	# Export file
	writer = pd.ExcelWriter(r'\\rmb-vpr-file02\Ashburton\Support Services\Risk Management\Investment Analytics\Python\take_on\reports\liability_models\RMA_RML\RMA_LLM\RMA_LLM_liability_valuation_model_' + datetime_obj + '.xlsx')
