...
for dates in daterange:
	...
	df_cpi['adjusted_accrual_factor'] = 1.0
	...
	df = df[(df.PortfolioIDCode == '95027_risk_margin')]
	...
	# Export file
	writer = pd.ExcelWriter(r'\\rmb-vpr-file02\Ashburton\Support Services\Risk Management\Investment Analytics\Python\take_on\reports\liability_models\RMA_RML\RMA_LLM\RMA_LLM_risk_margin_liability_valuation_model_' + datetime_obj + '.xlsx')
