...
for dates in daterange:
	...
	df = df[(df.PortfolioIDCode == '95925_expenses')]
	...
	# Export file
	writer = pd.ExcelWriter(r'\\rmb-vpr-file02\Ashburton\Support Services\Risk Management\Investment Analytics\Python\take_on\reports\liability_models\RMA_RML\RML_LLM\RML_LLM_expenses_liability_valuation_model_' + datetime_obj + '.xlsx')
