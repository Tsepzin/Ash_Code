...
for dates in daterange:
	...
	df = df[(df.PortfolioIDCode == '95924_ibnr')]
	...
	my_dates = pd.read_excel(r'\\rmb-vpr-file02\Ashburton\Support Services\Risk Management\Investment Analytics\Python\take_on\config\my_dates_ibnr.xlsx')
	...
	# Export file
	writer = pd.ExcelWriter(r'\\rmb-vpr-file02\Ashburton\Support Services\Risk Management\Investment Analytics\Python\take_on\reports\liability_models\RMA_RML\RML_ANNUITY\RML_ANNUITY_ibnr_liability_valuation_model_' + datetime_obj + '.xlsx')
