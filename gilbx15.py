...
for dates in daterange:
	...
	df['Portfolio Code'].iloc[3] = 'Total'
	df['Instrument Code'].iloc[3] = ''
	df.to_csv(r'\\rmb-vpr-file02\Ashburton\Support Services\Risk Management\Investment Analytics\Python\take_on\reports\liability_models\gilbx15\gilbx15_' + str(dates.date()) + '.csv', index=False)
